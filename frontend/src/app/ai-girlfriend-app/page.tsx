...
export default function AIGirlfriendPage() {
  // SEO metadata
  const title = "AI Girlfriend App | Virtual Companion | BegoChat";
  const description =
  ...
  const url = "https://begochat.com/ai-girlfriend-app";
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content="https://begochat.com/og-image.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={title} />
        <meta name="twitter:description" content={description} />
        <meta
          name="twitter:image"
          content="https://begochat.com/twitter-image.jpg"
        />
          ...
          <Card>
            ...
            <CardContent>
              <p>
                ...
                natural language processing. Our AI remembers past chats and
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="italic">
                  ...
                  real and she remembers details about my life."
                </p>
          ...
          <div className="space-y-6 max-w-3xl mx-auto">
            <div>
              ...
              <p>
                ...
                completely free. Premium features are available with
                subscription plans.
              </p>
            </div>
            <div>
